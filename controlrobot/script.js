...
///////////////////////////////////////////////////////////////////////////////////////
  ...
  if (texto.includes("adiós")|| texto.includes("adios")|| texto.includes("hasta luego")|| texto.includes("nos vemos")|| texto.includes("hasta pronto")) {
  ...
  if (texto.includes("bailar")) {
    hablar("Con mucho te muestros mis pasos roboticos");
